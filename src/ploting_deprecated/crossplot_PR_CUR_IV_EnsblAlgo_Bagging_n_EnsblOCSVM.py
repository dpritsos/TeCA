...
def plot_data(Res1, Res2, kfolds, featr_size_lst1, featr_size_lst2, nu):
    ...
    for i_fs, featr_size in enumerate(featr_size_lst1):
        ...
        for k in range(kfolds):  
            ...
            PS_lst.append( Res2.getNode('/KFold'+str(k)+'/Feat'+str(featr_size)+'/Iters100/Sigma0.5/Bagg0.66', name='predicted_scores' ).read() )
            exp_y = Res2.getNode('/KFold'+str(k)+'/Feat'+str(featr_size)+'/Iters100/Sigma0.5/Bagg0.66', name='expected_Y' ).read()
            pre_y = Res2.getNode('/KFold'+str(k)+'/Feat'+str(featr_size)+'/Iters100/Sigma0.5/Bagg0.66', name='predicted_Y' ).read()
...
if __name__ == '__main__':
    ...
    EnsAlgo = tb.openFile('/home/dimitrios/Synergy-Crawler/KI-04/C-KI04_TT-Char4Grams-Koppels_method_kfolds-10_SigmaThreshold-None_Bagging.h5', 'r')
