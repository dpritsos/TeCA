...
class HTML2TF(VHTools, RegexHTML2TFTools):
    ...
    def html2tfv_n_tfd(self, basefrom_l, pathsfrom, tfv_file, tfd_file, err_file, encoding='utf-8', error_handling='strict', low_mem='True'):
...
class HTML2NgF(VHTools, RegexHTML2NgFTools):
    ...
    def htmlngfv_n_ngfd(self, basefrom_l, pathsfrom, ngfv_file, ngfd_file, encoding='utf-8', error_handling='strict', low_mem='True'):
        pass
