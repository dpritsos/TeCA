...
params_od = coll.OrderedDict([
    ...
    ('features_size', [1000]),  # [1000, 5000, 10000, 50000, 90000]
    #(Bagging', [0.66]),
...
conf_matrix_fname = '/home/dimitrios/Documents/MyPublications:Journals-Conferences/Journal_IPM-Elsevier/tables_data/Confusion_tables/Conf_MIX_4Chars_SANTINIS_PSet(100k,10k,09,100).csv'
