...
from teca.analytics.metrix import bcubed_pr_scores
from teca.data_retrieval.semisupervised_data import get_predictions
...
h5df_str = str(
    '/home/dimitrios/Synergy-Crawler/Santinis_7-web_genre/SemiSupClust_W1G_7Genres/' +
    'HMRFKmeans_W1G_7Genres_LSI30.h5'
